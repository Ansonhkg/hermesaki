...
const rows=[
 ...
 ['invalid','Invalid credential','#status','An invalid token keeps the sign-in screen available for retry.'],
 ['empty','Your first inbox','#create','No inboxes yet. Create Atlas using fictional data.'],
